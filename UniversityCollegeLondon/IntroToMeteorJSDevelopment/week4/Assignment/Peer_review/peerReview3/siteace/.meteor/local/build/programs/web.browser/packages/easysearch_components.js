  ...
  return {                                                                                                 // 2
    ...
    addProps: function () {                                                                                // 122
      ...
      options.props = options.props || {};                                                                 // 125
                                                                                                           //
      if (_.isObject(arguments[0])) {                                                                      // 127
        options.props = _.extend(options.props, arguments[0]);                                             // 128
      } else if (_.isString(arguments[0])) {                                                               //
        options.props[arguments[0]] = arguments[1];                                                        // 130
      }                                                                                                    //
                                                                                                           //
    ...
    function onCreated() {                                                                                 // 10
      ...
      this.debouncedSearch = _.debounce(function (searchString) {                                          // 16
        searchString = searchString.trim();                                                                // 17
                                                                                                           //
        if (_this.searchString !== searchString) {                                                         // 19
          _this.searchString = searchString;                                                               // 20
                                                                                                           //
          _this.eachIndex(function (index, name) {                                                         // 22
            index.getComponentDict(name).set('currentPage', 1);                                            // 23
          });                                                                                              //
                                                                                                           //
          _this.search(searchString);                                                                      // 26
        }                                                                                                  //
