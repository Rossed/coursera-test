...
install("coffeescript");                                                     // 40
install("jquery", "meteor/jquery/main.js");                                  // 41
install("tracker");                                                          // 42
install("base64");                                                           // 43
install("ejson");                                                            // 44
...
install("blaze");                                                            // 56
install("spacebars");                                                        // 57
install("templating");                                                       // 58
install("handlebars");                                                       // 59
install("mizzao:sharejs");                                                   // 60
install("mizzao:sharejs-codemirror");                                        // 61
install("twbs:bootstrap");                                                   // 62
install("npm-bcrypt");                                                       // 63
...
install("ddp");                                                              // 71
install("ordered-dict");                                                     // 72
install("geojson-utils", "meteor/geojson-utils/main.js");                    // 73
install("minimongo");                                                        // 74
install("ddp-server");                                                       // 75
install("allow-deny");                                                       // 76
install("mongo");                                                            // 77
...
install("meteor-base");                                                      // 88
install("mobile-experience");                                                // 89
install("blaze-html-templates");                                             // 90
install("logging");                                                          // 91
install("standard-minifier-css");                                            // 92
install("standard-minifier-js");                                             // 93
install("webapp");                                                           // 94
install("livedata");                                                         // 95
install("hot-code-push");                                                    // 96
install("launch-screen");                                                    // 97
install("autoupdate");                                                       // 98
