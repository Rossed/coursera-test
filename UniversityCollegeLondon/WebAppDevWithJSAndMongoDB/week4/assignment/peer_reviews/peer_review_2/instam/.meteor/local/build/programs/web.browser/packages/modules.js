...
install("iron:controller");                                                  // 83
install("iron:router");                                                      // 84
...
install("session");                                                          // 92
install("twbs:bootstrap");                                                   // 93
install("fortawesome:fontawesome");                                          // 94
install("aldeed:simple-schema");                                             // 95
install("livedata");                                                         // 96
install("momentjs:moment");                                                  // 97
install("raix:eventemitter");                                                // 98
install("aldeed:collection2-core");                                          // 99
install("aldeed:schema-index");                                              // 100
install("aldeed:schema-deny");                                               // 101
install("aldeed:collection2");                                               // 102
install("aldeed:autoform");                                                  // 103
install("service-configuration");                                            // 104
install("less");                                                             // 105
install("accounts-ui-unstyled");                                             // 106
install("accounts-ui");                                                      // 107
install("webapp");                                                           // 108
