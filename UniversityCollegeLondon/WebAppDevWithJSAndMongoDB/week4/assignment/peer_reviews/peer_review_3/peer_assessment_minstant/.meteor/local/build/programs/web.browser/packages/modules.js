...
install("deps");                                                             // 67
install("htmljs");                                                           // 68
install("observe-sequence");                                                 // 69
install("reactive-var");                                                     // 70
install("blaze");                                                            // 71
install("ui");                                                               // 72
install("spacebars");                                                        // 73
install("templating");                                                       // 74
install("iron:core");                                                        // 75
install("iron:dynamic-template");                                            // 76
install("iron:layout");                                                      // 77
install("iron:url");                                                         // 78
install("iron:middleware-stack");                                            // 79
install("iron:location");                                                    // 80
install("iron:controller");                                                  // 81
install("iron:router");                                                      // 82
install("ddp-rate-limiter");                                                 // 83
install("localstorage");                                                     // 84
install("callback-hook");                                                    // 85
install("accounts-base", "meteor/accounts-base/client_main.js");             // 86
install("sha");                                                              // 87
install("srp");                                                              // 88
install("accounts-password");                                                // 89
install("twbs:bootstrap");                                                   // 90
install("standard-minifier-css");                                            // 91
install("standard-minifier-js");                                             // 92
install("shell-server");                                                     // 93
install("emojione:emojione");                                                // 94
install("service-configuration");                                            // 95
install("less");                                                             // 96
install("accounts-ui-unstyled");                                             // 97
install("accounts-ui");                                                      // 98
install("webapp");                                                           // 99
install("livedata");                                                         // 100
install("hot-code-push");                                                    // 101
install("launch-screen");                                                    // 102
install("autoupdate");                                                       // 103
                                                                             // 104
///////////////////////////////////////////////////////////////////////////////
