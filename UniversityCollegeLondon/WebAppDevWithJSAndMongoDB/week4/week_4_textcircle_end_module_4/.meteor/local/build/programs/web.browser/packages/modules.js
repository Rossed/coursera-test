...
install("promise", "meteor/promise/client.js");                              // 36
install("ecmascript-runtime", "meteor/ecmascript-runtime/runtime.js");       // 37
install("babel-compiler");                                                   // 38
install("coffeescript");                                                     // 39
install("jquery", "meteor/jquery/main.js");                                  // 40
install("tracker");                                                          // 41
install("base64");                                                           // 42
install("ejson");                                                            // 43
...
install("htmljs");                                                           // 46
install("id-map");                                                           // 47
install("ecmascript");                                                       // 48
install("babel-runtime");                                                    // 49
install("random");                                                           // 50
install("mongo-id");                                                         // 51
install("diff-sequence");                                                    // 52
install("observe-sequence");                                                 // 53
install("reactive-var");                                                     // 54
install("blaze");                                                            // 55
install("spacebars");                                                        // 56
install("templating");                                                       // 57
install("handlebars");                                                       // 58
install("mizzao:sharejs");                                                   // 59
install("mizzao:sharejs-codemirror");                                        // 60
install("twbs:bootstrap");                                                   // 61
install("npm-bcrypt");                                                       // 62
install("ddp-rate-limiter");                                                 // 63
install("localstorage");                                                     // 64
install("callback-hook");                                                    // 65
install("retry");                                                            // 66
install("ddp-common");                                                       // 67
install("reload");                                                           // 68
install("ddp-client");                                                       // 69
install("ddp");                                                              // 70
install("ordered-dict");                                                     // 71
install("geojson-utils", "meteor/geojson-utils/main.js");                    // 72
install("minimongo");                                                        // 73
...
install("sha");                                                              // 78
install("srp");                                                              // 79
install("accounts-password");                                                // 80
install("reactive-dict");                                                    // 81
install("session");                                                          // 82
install("stylus");                                                           // 83
install("ui");                                                               // 84
install("anti:i18n");                                                        // 85
install("ian:accounts-ui-bootstrap-3");                                      // 86
install("gwendall:body-events");                                             // 87
install("lai:collection-extensions");                                        // 88
install("dburles:mongo-collection-instances");                               // 89
install("babrahams:editable-text");                                          // 90
install("iron:core");                                                        // 91
install("iron:dynamic-template");                                            // 92
install("iron:layout");                                                      // 93
install("iron:url");                                                         // 94
install("iron:middleware-stack");                                            // 95
install("iron:location");                                                    // 96
install("iron:controller");                                                  // 97
install("iron:router");                                                      // 98
install("aldeed:simple-schema");                                             // 99
install("livedata");                                                         // 100
install("momentjs:moment");                                                  // 101
install("raix:eventemitter");                                                // 102
install("aldeed:collection2-core");                                          // 103
install("aldeed:schema-index");                                              // 104
install("aldeed:schema-deny");                                               // 105
install("aldeed:collection2");                                               // 106
install("aldeed:autoform");                                                  // 107
install("meteor-base");                                                      // 108
install("mobile-experience");                                                // 109
install("blaze-html-templates");                                             // 110
install("logging");                                                          // 111
install("standard-minifier-css");                                            // 112
install("standard-minifier-js");                                             // 113
install("djedi:sanitize-html");                                              // 114
install("webapp");                                                           // 115
install("hot-code-push");                                                    // 116
install("launch-screen");                                                    // 117
install("autoupdate");                                                       // 118
install("service-configuration");                                            // 119
