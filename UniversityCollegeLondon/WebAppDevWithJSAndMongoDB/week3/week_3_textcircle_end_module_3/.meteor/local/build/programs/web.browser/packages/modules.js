...
install("meteor-base");                                                      // 91
install("mobile-experience");                                                // 92
install("blaze-html-templates");                                             // 93
install("logging");                                                          // 94
install("standard-minifier-css");                                            // 95
install("standard-minifier-js");                                             // 96
install("djedi:sanitize-html");                                              // 97
install("webapp");                                                           // 98
install("livedata");                                                         // 99
